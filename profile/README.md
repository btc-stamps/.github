...
Libraries, SDKs, and developer tools for building on [Bitcoin Stamps](https://bitcoinstamps.xyz) — unprunable data storage on Bitcoin.
...
- [**BTCStampsExplorer**](https://github.com/stampchain-io/BTCStampsExplorer) — REST API and block explorer at [stampchain.io](https://stampchain.io)
- [**stampchain-mcp**](https://github.com/stampchain-io/stampchain-mcp) — MCP server for AI integration

### Links

- [bitcoinstamps.xyz](https://bitcoinstamps.xyz) — Protocol home
